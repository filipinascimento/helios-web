export const NODE_ATTRIBUTE_VERTEX = /* glsl */ `#version 300 es
layout (location = 0) in vec2 a_corner;
layout (location = 1) in vec3 a_position;
layout (location = 2) in float a_size;
layout (location = 3) in uvec4 a_encoded;
...
export const EDGE_ATTRIBUTE_VERTEX = /* glsl */ `#version 300 es
layout (location = 0) in vec3 a_start;
layout (location = 1) in vec3 a_end;
layout (location = 2) in vec2 a_width;
layout (location = 3) in vec2 a_endpointSize;
layout (location = 4) in uvec4 a_encoded;
...
export const EDGE_ATTRIBUTE_QUAD_VERTEX = /* glsl */ `#version 300 es
layout (location = 0) in vec2 a_corner;
...
layout (location = 5) in uvec4 a_encoded;
